                  ...
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      <Text
                        ...
                        Menu Item Name ({modalData.menuItems.length})
                      </Text>
                      <Image
                        style={{
                          height: 18,
                    ...
                    {showMenuItems ? (
                      <View>
                        {modalData && modalData.menuItems.length > 0 ? (
                      ...
                      <View>
                        <ScrollView
                          ...
                          <View>
                            ...
                            <View>
                              {modalData &&
                              modalData.recipeVersions[0].ingredients.length >
                                0 ? (
                                modalData.recipeVersions[0].ingredients.map(
                                  (item, index) => {
                                    return (
                                      <View
                                        style={{
